...
public interface QueryBuilderCreateTable extends ReturningQuery<QueryBuilderCreateTable, AbstractSqlTable> {
     ...
     */
    QueryBuilderCreateTable addColumn(String columnName, SqlType type);
     ...
     * @return self Query Builder
     */
    QueryBuilderCreateTable addColumn(String columnName, SqlType type, Integer size);
     ...
     * @return self Query Builder
     */
    QueryBuilderCreateTable addColumn(String columnName, SqlType type, Integer size, ColumnData... columnData);
     ...
     * @return self Query Builder
     */
    QueryBuilderCreateTable addColumn(String columnName, SqlType type, boolean autoIncrement);
     ...
     * @return self Query Builder
     */
    QueryBuilderCreateTable addColumn(String columnName, SqlType type, ColumnData... columnData);
     ...
     * @return self Query Builder
     */
    QueryBuilderCreateTable addColumn(String columnName, SqlType type, String defaultValue, ColumnData... columnData);
     ...
     * @return self Query Builder
     */
    QueryBuilderCreateTable addColumn(String columnName, SqlType type, Integer size, String defaultValue, boolean notNull, boolean autoIncrement, String constraint);
     ...
     * @return self Query Builder
     */
    QueryBuilderCreateTable addColumn(String columnName, SqlType type, Integer size, String defaultValue, String constraint, ColumnData... columnData);
