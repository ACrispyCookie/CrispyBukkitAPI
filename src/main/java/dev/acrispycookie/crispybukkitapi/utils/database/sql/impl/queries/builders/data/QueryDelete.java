...
import dev.acrispycookie.crispybukkitapi.utils.database.sql.api.sql.queries.builders.data.QueryBuilderDelete;
...
public class QueryDelete extends SqlQuery implements QueryBuilderDelete {
    ...
    public QueryDelete(SqlConnector connector, String database) {
    ...
    public QueryBuilderDelete patternClone() {
        QueryDelete copy = new QueryDelete(connector, databaseName);
        copy.limit = limit;
