...
import dev.acrispycookie.crispybukkitapi.utils.database.sql.api.sql.queries.builders.data.QueryBuilderInsert;
...
public class QueryInsert extends SqlQuery implements QueryBuilderInsert {
    ...
    public QueryInsert(SqlConnector connector, String database) {
    ...
    public QueryBuilderInsert patternClone() {
        QueryInsert copy = new QueryInsert(connector, databaseName);
