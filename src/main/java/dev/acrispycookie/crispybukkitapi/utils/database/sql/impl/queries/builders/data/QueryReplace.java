...
import dev.acrispycookie.crispybukkitapi.utils.database.sql.api.sql.queries.builders.data.QueryBuilderReplace;
...
public class QueryReplace extends SqlQuery implements QueryBuilderReplace {
    ...
    public QueryReplace(SqlConnector connector, String database) {
    ...
    public QueryBuilderReplace patternClone() {
        QueryReplace copy = new QueryReplace(connector, databaseName);
