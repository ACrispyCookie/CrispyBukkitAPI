...
import dev.acrispycookie.crispybukkitapi.utils.database.sql.api.sql.queries.builders.data.QueryBuilderSelect;
...
public class QuerySelect extends SqlQuery implements QueryBuilderSelect {
    ...
    public QuerySelect(SqlConnector holder, String database) {
    ...
    public QueryBuilderSelect patternClone() {
        QuerySelect copy = new QuerySelect(connector, databaseName);
