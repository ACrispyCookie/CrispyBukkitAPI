...
import dev.acrispycookie.crispybukkitapi.utils.database.sql.impl.structure.ForeignKeyDefinition;
import dev.acrispycookie.crispybukkitapi.utils.database.sql.impl.structure.SqlColumn;
import dev.acrispycookie.crispybukkitapi.utils.database.sql.impl.structure.SqlDatabase;
import dev.acrispycookie.crispybukkitapi.utils.database.sql.impl.structure.SqlTable;
...
public class QueryCreateTable extends SqlQuery implements QueryBuilderCreateTable {
    ...
    public QueryBuilderCreateTable addColumn(String columnName, SqlType type, Integer size, String defaultValue, String constraint, ColumnData... columnData) {
        columns.add(new SqlColumn(columnName, type, size, defaultValue, constraint, columnData));
        return this;
    }
    ...
    @Override
    public PreparedStatement asPrepared() throws SQLException {
    ...
    public Deque<SqlColumn> getColumns() {
        return columns;
    }
